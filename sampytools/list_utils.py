...
def add_new_values_in_certain_item_location(
    orig_list: List[Any],
    item_val: Union[str, int, float],
    new_vals: List[Any],
    include_orig_item: bool = True,
) -> List[Any]:
    """
...
def get_unique_records_from_list(
    alist: List[Union[str, int, float, Any]],
) -> List[Union[str, int, float, Any]]:
    """
...
def get_dupe_and_nondupe_items_from_list(
    alist: List[str],
